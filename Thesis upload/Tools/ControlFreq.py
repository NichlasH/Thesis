...
file_name = '../Files/ControlTweets.txt'
...
with open(file_name, 'r', encoding="utf8",errors='ignore') as f:
    ...
    ControlWords = '../Output/Control/ControlWords.csv'

    with open(ControlWords, 'w', encoding="utf8",errors='ignore') as csvFile:
    	csv_out = csv.writer(csvFile, delimiter=",", lineterminator="\r\n")
    	csv_out.writerow(['Name','Count'])
    	for row in dist:
       		 csv_out.writerow(row)

    with open('../Output/Control/ControlWords.txt', 'w', encoding="utf8",errors='ignore') as File:
    ...
    ControlNegatives = '../Output/Control/ControlNegatives.csv'

    # rt = retweet
    with open(ControlNegatives, 'w', encoding="utf8",errors='ignore') as csvFile:
    	csv_out = csv.writer(csvFile, delimiter=",", lineterminator="\r\n")
    	csv_out.writerow(['Name','Count'])
    	for row in dist:
       		 csv_out.writerow(row)
    ...
    with open('../Output/Control/ControlNegatives.txt', 'w', encoding="utf8",errors='ignore') as File:
    	File.write(('\n'.join('%s %s' % x for x in dist)))
    ...
    ControlPositives = '../Output/Control/ControlPositives.csv'

# rt = retweet
    with open(ControlPositives, 'w', encoding="utf8",errors='ignore') as csvFile:
    	csv_out = csv.writer(csvFile, delimiter=",", lineterminator="\r\n")
    	csv_out.writerow(['Name','Count'])
    	for row in dist:
       		 csv_out.writerow(row)
...
# rt = retweet 
    with open('../Output/Control/ControlPositives.txt', 'w', encoding="utf8",errors='ignore') as File:
    	File.write(('\n'.join('%s %s' % x for x in dist)))
    	



remove_bom_inplace('../Output/Control/ControlNegatives.csv')
remove_bom_inplace('../Output/Control/ControlPositives.csv')
remove_bom_inplace('../Output/Control/ControlWords.csv')
